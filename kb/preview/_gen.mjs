...
${HEAD}
      ...
      <article class="kb-body kb-numbered">
        ...
        <p>費用是<strong>兩個人各付各的</strong>。「登錄了沒有」是各自計算的，所以兩邊看到的數字可能不一樣。</p>

        <p>想省沙子，<strong>先確認對方圖鑑裡有沒有登錄</strong>，比衝友誼等級有用。同樣一隻異色，對方有登錄的話在正港好朋友之間是 800，沒登錄就要 40,000。</p>
...
${HEAD}
      ...
      <article class="kb-body">
        <section class="qa">
          ...
          <p>費用是<strong>兩個人各付各的</strong>。「登錄了沒有」是各自計算的，所以兩邊看到的數字可能不一樣。想省沙子，<strong>先確認對方圖鑑裡有沒有登錄</strong>，比衝友誼等級有用。同樣一隻異色，對方有登錄的話在正港好朋友之間是 800，沒登錄就要 40,000。</p>
...
${COST}
            ...
            <ul class="pts">
              <li>費用是<strong>兩個人各付各的</strong>，而「登錄了沒有」各自計算，所以兩邊看到的數字可能不一樣。</li>
              <li>想省沙子，<strong>先確認對方圖鑑裡有沒有登錄</strong>，比衝友誼等級有用。同樣一隻異色，對方有登錄的話在正港好朋友之間是 800，沒登錄就要 40,000。</li>
            </ul>
