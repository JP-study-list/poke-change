...
export const STRINGS = {
  zh: {
    ...
    lockedBySub: "已有異色或亮晶晶，代表也擁有這個裝扮",
    close: "關閉",
    ...
    wantNone: "還沒有加入這隻",
    wantNoTrade: "神話寶可夢無法交換，因此不能加入清單。",
    wantAny: "不指定條件",
    wantEdit: "編輯",
    wantRemove: "移除",
    wantDone: "完成",
  ...
  ja: {
    ...
    lockedBySub: "色違いやキラを所持しているため、このコスチュームも所持しています",
    close: "閉じる",
    ...
    wantNoTrade: "幻のポケモンは交換できないため、リストに追加できません。",
    wantAny: "条件なし",
    wantEdit: "編集",
    wantRemove: "削除",
    wantDone: "完了",
  ...
  en: {
    ...
    lockedBySub: "You own a shiny or lucky one, so you own this costume",
    close: "Close",
    ...
    wantNoTrade: "Mythical Pokémon can't be traded, so they can't be added.",
