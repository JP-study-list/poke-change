 ...
 *
 * ── 譯名怎麼取的 ──
 * 沒有官方名稱可以對照，所以一律看圖命名，取「看得出是哪一個」為原則。
 * 例如 PI 這個代碼看不出含意，但圖上就是一頂咖啡色鴨舌帽，那就叫鴨舌帽。
 * 覺得不好認就直接改這裡，改完重跑 tools/build-dex.mjs。
 */
...
export const COSTUME_NAMES = {
  ...
  PI: ["鴨舌帽", "ハンチング帽", "Flat Cap"],
  2020: ["2020 新年眼鏡", "2020お正月メガネ", "New Year 2020 Glasses"],
  2021: ["2021 新年眼鏡", "2021お正月メガネ", "New Year 2021 Glasses"],
  2022: ["2022 新年眼鏡", "2022お正月メガネ", "New Year 2022 Glasses"],
};
