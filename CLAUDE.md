...
這裡收 1483 個條目，其中 303 個裝扮橫跨一百多個物種，
再加 240 張背卡收在 23 個收納夾裡、195 個收集格。

背卡的圖與代號抓得到上游，「哪些寶可夢帶得了這張背卡」上游沒有，
靠 Dittobase 補、Serebii 與 Bulbapedia 交叉比對。240 張裡 215 張有清單。
...
- **自動與手工兩批的 id 慣例不一致**。自動那批用型態層級
  （`d128.fPALDEA_COMBAT`），手工那 17 張沿用「合併成本體加註記」
  （`d128` 加 note）。兩種都能跑，但同一個裝扮在不同卡片上長得不一樣。
